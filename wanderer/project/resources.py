...
class Resources:
    ...
    def __init__(self):
        ...
        self.images['Skeleton'] = self.load_image('project/assets/skeleton.gif')
        self.images['hero-down'] = self.load_image('project/assets/hero-down.gif')
        self.images['hero-left'] = self.load_image('project/assets/hero-left.gif')
        self.images['hero-right'] = self.load_image('project/assets/hero-right.gif')
